...
<html lang="en">
    ...
    <script>
        ...
        $(document).ready(function(){
            $.ajax({
                url:'http://localhost/PHP-native-projects/pengolahan-data-penduduk/src/JumlahPekerjaTerbanyak.php',
                type:'GET',
            ...
            $.ajax({
                url:'http://localhost/PHP-native-projects/pengolahan-data-penduduk/src/PelajarKota.php',
                type:'GET',
                success: function(data){
                    const parsedData = JSON.parse(data);
                    const dataJumlah = [];
            ...
            $.ajax({
                url:'http://localhost/PHP-native-projects/pengolahan-data-penduduk/src/PerbandinganPekerjaDanTidak.php',
                type:'GET',
                success: function(data){
                    const parsedData = JSON.parse(data);
                    const dataJumlah = [];
